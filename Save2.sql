...
SELECT GAME_ID, PIT_ID, INN_CT, BAT_HOME_ID, OUTS_CT, AWAY_SCORE_CT, HOME_SCORE_CT, IF(BASE1_RUN_ID = '', 0, 1) AS onFirst, IF(BASE2_RUN_ID = '', 0, 1) AS onSecond, IF(BASE3_RUN_ID = '', 0, 1) AS onThird, IF(SAVE_PIT_ID = '', 'None', SAVE_PIT_ID)
FROM pitching_data;
